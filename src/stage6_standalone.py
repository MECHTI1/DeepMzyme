...
def _build_train_command(config: dict[str, Any], repo_dir: Path) -> list[str]:
    ...
    scalar_flags = [
        ...
        ("metal_eligibility_scheme", "--metal-eligibility-scheme"),
        ...
        ("site_geometry_features", "--site-geometry-features"),
        ...
        ("shell_role_source", "--shell-role-source"),
        ...
        ("ec_class_weight_unit", "--ec-class-weight-unit"),
        ...
        ("split_by", "--split-by"),
        ("split_stratify_by", "--split-stratify-by"),
    ]
