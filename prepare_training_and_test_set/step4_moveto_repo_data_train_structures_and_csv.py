...
from project_paths import CATALYTIC_ONLY_SUMMARY_CSV, DATA_DIR, MEDIA_DATA_ROOT, STRUCTURE_STORE_DIR
...
DEST_DIR = DATA_DIR / "train_and_test_sets_structures_exact_pinmymetal" / "train"
