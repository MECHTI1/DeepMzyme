...
## Sequence-remoteness evidence

| Experiment ID | Design | Result role | Grade | Held-out access | Evidence |
|---|---|---|---:|---|---|
| `diagnostic/remote-homology-pilot-v1/2026-09-17` | One component-preserving diagnostic split; two direct-four, seed-42, 50-epoch standalone fits; outer evaluation after both checkpoints froze | GVP BA 44.61% vs ESM 54.29%; directional shift −8.45 pp; Cu recall 0/14; practical stop decision | Exploratory diagnostic only; not Stage 6 | None; development-only outer evaluation | [summary](summaries/summary_diagnostic_remote_pilot_v1_20260917.md); canonical artifacts under `DeepMzyme_Data/notebook_outputs/remote_homology_v1/diagnostic_pilot_v1/` |
...
| Experiment ID | Design | Result role | Grade | Held-out access | Evidence |
|---|---|---|---:|---|---|
| `metal/pmm-ion-v2-context/2026-09-26` | 7,398 ions/3,992 PDB groups after 503 explicit protein-symmetry-context exclusions; released PMM recipe on five frozen grouped folds; common-four endpoint | PMM mean-fold BA 70.2885%, pooled OOF BA 70.0766%; nine GPU smokes and one full Only-ESM/direct-four fold verified (BA 88.3945%). GPU zone recovery verified; new ESMC screen fit refused by remaining-time admission. Full grid deferred. No superiority or promotion | 2 for completed PMM fivefold; 5 for individual neural fit; 6 for incomplete neural grid and smoke | None; no final refit or primary final-test claim | [summary](summaries/summary_pmm_ion_v2_context_20260926.md); [portable evidence](raw/pmm_ion_v2_context_20260926/README.md) |
