...
def summarize_run(run_dir: Path) -> dict[str, Any]:
    ...
    row = {
        ...
        "run_dir": str(run_dir),
        "task": task,
        "metal_label_scheme": first_present(
            config.get("metal_label_scheme"),
            dataset.get("metal_label_scheme"),
            run_metadata.get("metal_label_scheme"),
            run_config.get("metal_label_scheme"),
        ),
        ...
        "train_val_split_by": first_present(
            split_diagnostics.get("train_val_split_by"),
            dataset.get("train_val_split_by"),
            config.get("train_val_split_by"),
