...
def check_colab_notebook_sweep_source() -> None:
    ...
    required_tokens = (
        ...
        'OPTUNA_WEIGHT_DECAY_RANGE = ""  #@param {type:"string"}',
        'OPTUNA_HIDDEN_S_RANGE = ""  #@param {type:"string"}',
        'OPTUNA_HIDDEN_V_RANGE = ""  #@param {type:"string"}',
        'OPTUNA_EDGE_HIDDEN_RANGE = ""  #@param {type:"string"}',
        'OPTUNA_EDGE_RADIUS_RANGE = ""  #@param {type:"string"}',
        'OPTUNA_HEAD_MLP_LAYERS_RANGE = ""  #@param {type:"string"}',
        'OPTUNA_HEAD_MLP_DROPOUT_RANGE = ""  #@param {type:"string"}',
        'OPTUNA_POSITION_NOISE_STD_RANGE = ""  #@param {type:"string"}',
        'OPTUNA_OUTER_RESIDUE_DROPOUT_RANGE = ""  #@param {type:"string"}',
        'OPTUNA_METAL_FOCAL_GAMMA_RANGE = ""  #@param {type:"string"}',
        'OPTUNA_METAL_LABEL_SMOOTHING_RANGE = ""  #@param {type:"string"}',
